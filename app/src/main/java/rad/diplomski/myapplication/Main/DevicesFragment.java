...
import rad.diplomski.myapplication.adapters.ListViewFragmentAdapter;
...
public class DevicesFragment extends Fragment{
	...
	public Builder menuListViewDialog;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		menuListViewDialog =  new Builder(getActivity());
...
//		getActivity().invalidateOptionsMenu();
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		final Builder setDeviceNameDialog = new Builder(getActivity()).setTitle("Device Name").
...
//					nameRepitedDialog.show();
		...
		final Builder removeAllDevicesDialog = new Builder(getActivity()).setTitle("Remove all devices").
    	...
    	switch (requestCode) {
	        ...
	        if (resultCode == Activity.RESULT_OK) {
	            ...
	            if (newAddress){
					...
					Builder selectedAddressDialog = new Builder(mActivity).setTitle("Bluetooth Address Already Selected");
